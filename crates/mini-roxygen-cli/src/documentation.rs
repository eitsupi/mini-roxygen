...
mod tests {
    ...
    fn installed_help_alias_and_canonical_requests_share_topic_cache() {
        ...
        crate::test_support::require_installed_documentation(&libraries, "utils");
        ...
        assert!(
            tested || !crate::test_support::installed_docs_required(),
...
"###);
    ...
    fn installed_rlang_inheritance_absolutizes_donor_relative_links_when_available() {
        let libraries = crate::test_support::installed_r_libraries();
        crate::test_support::require_installed_documentation(&libraries, "rlang");
        if libraries.is_empty() {
...
"#
        ...
        if crate::test_support::installed_docs_required() {
            assert!(
                tested,
